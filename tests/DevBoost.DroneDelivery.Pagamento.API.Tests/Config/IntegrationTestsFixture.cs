using Bogus;
using DevBoost.DroneDelivery.Pagamento.API;
...
namespace DevBoost.DroneDelivery.Test.Config
{
    ...
    {
        public readonly DroneDeliveryPagamentoAppFactory<TStartup> Factory;
        ...
        public IntegrationTestsFixture()
        {
            ...
            Factory = new DroneDeliveryPagamentoAppFactory<TStartup>();
